...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2014/10/16 00:10:40 by tseguier          #+#    #+#              #
#    Updated: 2014/10/16 00:10:47 by tseguier         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
outputs/format/ft_putldouble_f.c \
outputs/format/ft_putldouble_sci_f.c \
outputs/format/ft_putnbr_base_f.c \
outputs/format/ft_putnbr_f.c \
outputs/format/ft_putnbr_ull_len_f.c \
outputs/format/ft_putstr_f.c \
